...
import com.cun.register.service.PhantomJSDriverNew;
...
//        caps.setCapability(PhantomJSDriverService.PHANTOMJS_EXECUTABLE_PATH_PROPERTY, pathContext.getDriver_path());
        ...
        caps.setCapability(PhantomJSDriverService.PHANTOMJS_EXECUTABLE_PATH_PROPERTY, SpiderVariable.PHANTOMJS_PATH);
...
//        map.put("Referer", "https://gz.ac.10086.cn/aicas/login");
    ...
    public static void main(String[] args) {
        System.out.println(secToTime(36001));
    }
